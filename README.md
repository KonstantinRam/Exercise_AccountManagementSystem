# Task 3: Customer Account Management System with Modular Architecture
This challenge introduces INDEXED files, subprograms (CALL), and copybooks (COPY) - the foundation of enterprise COBOL.
